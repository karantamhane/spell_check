...
def check_spellings
  ...
  puts
  puts "Welcome to spellchecker! Enter '.' anytime to exit."
  print "Enter a word to spellcheck: "
  word = gets.chomp
  while word != '.'
    print "Closest suggestions for #{word} are: "
    print suggestions word, word_freq
    2.times do puts end
    print "Enter another word or press '.' to exit: "
    word = gets.chomp
  end
end
